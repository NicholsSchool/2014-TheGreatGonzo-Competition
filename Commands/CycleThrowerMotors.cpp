...
#include "CycleThrowerMotors.h"
CycleThrowerMotors::CycleThrowerMotors() {
...
void CycleThrowerMotors::Initialize() {
...
void CycleThrowerMotors::End() {
	Robot::throwerArm->stopThrowerMotors();
	
}
// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void CycleThrowerMotors::Interrupted() {
	Robot::throwerArm->stopThrowerMotors();
}
