...
DigitalInput* RobotMap::throwerArmFullyRetractedLimitSwitch = NULL;
SpeedController* RobotMap::intakeArmRollerMotor = NULL;
SpeedController* RobotMap::intakeArmIntakeArmMotor = NULL;
AnalogChannel* RobotMap::intakeArmIntakeArmPotentiometer = NULL;
...
void RobotMap::init() {
	...
	throwerArmFullyRetractedLimitSwitch = new DigitalInput(1, 5);
	lw->AddSensor("ThrowerArm", "FullyRetractedLimitSwitch", throwerArmFullyRetractedLimitSwitch);
	
	intakeArmRollerMotor = new Talon(1, 9);
	...
	intakeArmIntakeArmPotentiometer = new AnalogChannel(1, 1);
	lw->AddSensor("IntakeArm", "IntakeArmPotentiometer", intakeArmIntakeArmPotentiometer);
