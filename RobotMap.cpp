...
SpeedController* RobotMap::rollerMotorRollerMotor = NULL;
...
void RobotMap::init() {
	...
	rollerMotorRollerMotor = new Talon(1, 9);
	lw->AddActuator("RollerMotor", "RollerMotor", (Talon*) rollerMotorRollerMotor);
